...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-primary font-poppins text-secondary pt-8 pb-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap text-left lg:text-left">

          {/* Logo and description section */}
          <div className="w-full lg:w-6/12 px-4 mb-6 lg:mb-0">
            <img src={Logo} alt="logo" className="h-16 lg:h-24 mb-4" />
            <h5 className="text-base lg:text-lg mt-0 mb-2 text-blueGray-600">
              Driving the Clean Energy Future
            </h5>
            <p className="text-sm lg:text-base text-blueGray-600 mb-4">
              At Asiko Energy, we envision a future where clean energy is central to the well-being of individuals and the planet. Join us in our mission to build
              a healthier, safer, and more sustainable world through clean, reliable, innovative energy solutions.
            </p>
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="flex flex-wrap items-top mb-6">
              ...
              {/* Useful Links */}
              <div className="w-full lg:w-6/12 px-4">
                <span className="block uppercase text-mainColor text-sm font-semibold mb-2">Useful Links</span>
                <ul className="list-unstyled">
                  <li>
                    <NavLink to="/about"  onClick={closeActiveBar} className="text-secondary hover:text-mainColor font-semibold block pb-2 text-sm {isCurrentPage('/about')">About Us</NavLink>
                  </li>
                  <li>
                    <NavLink to="/"  onClick={closeActiveBar} className="text-secondary hover:text-mainColor font-semibold block pb-2 text-sm {isCurrentPage('/about')">The Group</NavLink>
                  </li>
                  <li>
                    <NavLink to="/"  onClick={closeActiveBar} className="text-secondary hover:text-mainColor font-semibold block pb-2 text-sm {isCurrentPage('/about')">News & Media</NavLink>
                  </li>
                  <li>
                    <NavLink to="/"  onClick={closeActiveBar} className="text-secondary hover:text-mainColor font-semibold block pb-2 text-sm {isCurrentPage('/about')">Sustainability</NavLink>
                  </li>
                  <li>
                    <NavLink to="/"  onClick={closeActiveBar} className="text-secondary hover:text-mainColor font-semibold block pb-2 text-sm {isCurrentPage('/about')">Privacy Policy</NavLink>
                  </li>
                </ul>
              </div>
              ...
              {/* Other Resources */}
              <div className="w-full lg:w-6/12 px-4">
                <span className="block uppercase text-mainColor text-sm font-semibold mb-2">GET IN TOUCH WITH US</span>
                <p className=''>Annexe Office 10 Ijora Causeway, Ijora Lagos. info@asikoenergy.com +234 2 293 2292</p>
              </div>
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full  px-4 mx-auto text-center">
            ...
            © Copyright 2025 Asiko Energy Holdings Limited. All Rights Reserved
            </div>
          </div>
        </div>
      </div>
