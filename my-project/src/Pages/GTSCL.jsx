...
import Gtscl from "../assets/GTSCL.png"
    ...
    <div>
      ...
      {/* Section 2 */}
             ...
             <div className="md:max-w-[50%] w-full">
              ...
              <p className="text-gray text-start mt-9 font-poppins">Responsible for providing access to critical coastal deliveries, safe storage and management of LPG, propane, and LNG products.</p>
              </div>
      
             <div className="md:max-w-[50%] w-full flex justify-center">
                <img src={Gtscl} alt="Career User" className="w-full max-w-full object-cover"/>
             </div>
             </div>
