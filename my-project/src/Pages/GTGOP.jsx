...
import Gtgol from "../assets/GTGOL.jpeg"
  ...
  return (
   ...
   {/* Section 2 */}
          ...
          <div className="md:max-w-[50%] w-full">
           ...
           <p className="text-gray text-start mt-9 font-poppins">Building and managing clean energy infrastructure in countries across West Africa.</p>
           </div>
   
          <div className="md:max-w-[50%] w-full flex justify-center">
             <img src={Gtgol} alt="Career User" className="w-full max-w-full object-cover"/>
          </div>
          </div>
